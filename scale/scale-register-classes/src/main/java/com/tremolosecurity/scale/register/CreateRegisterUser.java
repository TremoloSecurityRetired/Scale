...
public interface CreateRegisterUser {
	...
	public WFCall createTremoloUser(List<ScaleAttribute> attributes,List<String> errors,AttributeData attributesConfig, ScaleRegisterConfigType registerConfig);
}
