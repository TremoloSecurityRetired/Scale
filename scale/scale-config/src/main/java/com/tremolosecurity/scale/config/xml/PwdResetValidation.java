...
/**
 * Provides for validation of the user's selected password
 * 
 * <p>Java class for PwdResetValidation complex type.
 * 
...
@XmlType(name = "PwdResetValidation", propOrder = {
    "initParams"
})
public class PwdResetValidation {
